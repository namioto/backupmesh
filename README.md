...
Current version: **0.3.0** — the Storage app supports Korean and English, displays project information and GitHub links, and offers optional settings cleanup during uninstall. See the [changelog](CHANGELOG.md).
